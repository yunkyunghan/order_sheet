...
<td     align=left><b><asp:TextBox ID="txtTitle" runat="server" Width="40%"></asp:TextBox>공공 일반 금융 통신 보험 서비스 제조 국방 보건 프로젝트 </b></td>  

<td bgcolor="#efefef" width="10%" align=center><b> 일자 </b></td>
<td  align=left><b><asp:TextBox ID="txtps" runat="server" Width="50%" class="auto-kal"></asp:TextBox></b>
</td></tr></table>
<br>
...
<td  width="30%" align=left><b><asp:TextBox ID="txtts1" runat="server" Width="50%"></asp:TextBox></b>
Code </b>
...
<td bgcolor="#efefef" width="10%" align=center rowspan=10><b> 내용 </b></td>
<td width="50%" align=left valign=top rowspan=10><asp:TextBox ID="txtcs1" runat="server" TextMode="MultiLine"  width="95%" Rows="30"></asp:TextBox></td></tr>
<tr>
...
<td  align=left><!--<asp:Label ID="lblFileName" runat="server"></asp:Label>--><asp:FileUpload ID="FileUpload1" runat="server" /></asp:FileUpload></td></tr>

<tr><td bgcolor="#efefef" width="10%" align=center><b> 기간 </b></td><td  align=left><b><asp:TextBox ID="txtlink1" runat="server"   width="30%"></asp:TextBox>개월 년</td></tr>
<tr><td bgcolor="#efefef" width="10%" align=center><b> 언어 </b></td><td  align=left><b>
...
<tr><td bgcolor="#efefef" width="10%" align=center><b> 기술 </b></td><td  align=left><b><asp:TextBox ID="txttech1" runat="server"   width="80%"></asp:TextBox></td></tr>

<tr><td bgcolor="#efefef" width="10%" align=center><b> 업무 </b></td><td  align=left><b>
...
<tr><td bgcolor="#efefef" width="10%" align=center><b> 진행 </b></td><td align=left>
<asp:CheckBoxList ID="txtProgress1"    runat="server"    RepeatColumns="10" RepeatDirection="Horizontal" RepeatLayout="Table" CssClass="Radio" >
																...
																</asp:CheckBoxList></b></td></tr> 
<tr>
<td bgcolor="#efefef" width="10%" align=center><b> 마감 </b></td><td  align=left><asp:TextBox ID="txtDead1" runat="server"   width="20%" class="auto-kal"></asp:TextBox></asp:TextBox></td></tr>
<tr>
<td bgcolor="#efefef" width="10%" align=center><b> 업체 </b></td><td  align=left>
...
<tr height=30><td bgcolor="#efefef" width="10%" align=center><b> 내용 </b></td>
    <td   align=left><b><asp:TextBox ID="txtContent" runat="server" TextMode="MultiLine" width="95%" Rows="5" ></asp:TextBox></b></td></tr>
<!--<tr><td colspan=2>
